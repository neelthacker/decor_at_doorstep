...
<!-- Mirrored from demo.ovathemes.com/dvents/blog/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Apr 2020 07:57:10 GMT -->
...
<head>
    ...
    <title>Gallery &#8211; Decor at Doorstep</title>
...
<body class="page-template page-template-templates page-template-blog_template page-template-templatesblog_template-php page page-id-482 wpb-js-composer js-comp-ver-6.1 vc_responsive" >
...
<li class=" active"><a title="Gallery" href="index.php">Gallery</a></li>
...
<li><a href="index.php" aria-current="page">Gallery</a></li>
        ...
        <nav id="nav" class="navbar">
            <div class="container">
                ...
                <div class="header-navibox-2">
	                ...
	                <ul id="menu-primary-menu" class="yamm main-menu nav navbar-nav"><li>
	                	<a title="Home 2" href="../home-2/index.php">Home</a></li>
<li><a title="SERVICES" href="../services/index.php">SERVICES</a></li>
<li><a title="Events" href="../events/index.php">Events</a></li>
<li><a title="ABOUT" href="../about/index.php">ABOUT</a></li>
<li class=" active"><a title="GALLERY" href="index.php">GALLERY</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                        ...
                        <h1 class="b-title-page__title">The Gallery</h1>
                                        	                    <div id="breadcrumbs" >
		            ...
		            <div class="breadcrumbs">
						<div class="breadcrumbs-pattern">
							<div class="container">
								<div class="row">
									<ul class="breadcrumb"><li><a href="../index.php">Home</a></li>  <li>Gallery</li></ul>
										</div>
									</div>
								</div>
							</div></div>
  ...
  <?php  
                ...
                while($row = mysqli_fetch_array($result))
                	{
                		$Picture1=$row['name'];
                		?>
                                   <a href="../wp-content/uploads/2017/06/3-2-380x171.jpg" class="js-zoom-images"><?php echo ' <img src="data:image/jpeg;base64,'.base64_encode($Picture1 ).'" height="500" width="400" class="img-thumnail" />  
                                   ';?> </a>
                <?php	 } ?>
                </tr>
	...
	<div class="footer__main">
		<div class="container">
						<div class="row">
				<div class="col-xs-12">
					<div class="text-center"><a href="../index.php" class="footer__logo"><img src="../wp-content/uploads/2017/06/logo.png" alt="Decor at Doorstep"/></a></div>
				</div>
			</div>
            			<div class="row">
...
</div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input type="hidden" name="_mc4wp_timestamp" value="1586936998" /><input type="hidden" name="_mc4wp_form_id" value="506" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" /><div class="mc4wp-response"></div></form><!-- / Mailchimp for WordPress Plugin --></div>
											</div>
			</div>
			<div class="row">
				<div class="col-md-3">
...
<!-- Mirrored from demo.ovathemes.com/dvents/blog/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Apr 2020 07:58:09 GMT -->
</html>